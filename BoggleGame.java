    ...
    private class BoardPanel extends JPanel {
        ...
        public BoardPanel() {
            ...
            for (int i = 0; i < NUM_OF_CUBES; i++) {
                ...
                cubes[i].setBackground(new Color(178, 255, 102));
                            ...
                            for (int j = 0; j < path.length; j++) {
                                ...
                                // if the cube clicked is in the path
                                    ...
                                    if (j == path.length-1 || path[j+1] == -1) {
                                        cubes[cur].setBackground(new Color(178, 255, 102));
                                        path[j] = -1;
                                    }
                                    break;
                                }
        ...
        public void highlightCubes() {
            for (int i = 0; i < path.length; i++) {
                if (path[i] == -1) break;
                cubes[path[i]].setBackground(new Color(204, 255, 209));
            }
        }
        ...
        public void unhighlightCubes() {
            ...
            for (int i = 0; i < path.length; i++) {
                if (path[i] == -1) break;
                cubes[path[i]].setBackground(new Color(178, 255, 102));
            }
        }
